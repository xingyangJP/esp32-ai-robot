...
| FR-59 | Direct movement commands are treated as timed teleop, while search phrases remain goals. | `RobotController.handleDriveCommand()`, `runCommand()` | Source review: search words short-circuit command hijack; reverse/forward/turn/stop phrases are parsed. | Say/type "reverse for 2 seconds"; rover reverses for bounded time and STOP is visible. Say/type "find the person standing still"; AI search starts, not teleop STOP. |
